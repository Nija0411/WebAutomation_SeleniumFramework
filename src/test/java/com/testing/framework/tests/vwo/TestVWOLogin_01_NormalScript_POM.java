...
public class TestVWOLogin_01_NormalScript_POM extends CommonToAllTest {
    ...
    @Description("Verify that with the invalid email, password error message is shown on the app.vwo.com")
    @Test
    public void test_negative_vwo_login() {
        ...
        //Assertions -3
        assertThat(error_msg).isAlphabetic().isNotNull().isNotBlank().isNotEmpty();
